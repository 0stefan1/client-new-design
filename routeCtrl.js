(function(){
    ...
    app.constant('SENSOR_TYPE', {
                'ID': '0',
                'OUT_OF_RANGE_POSITIVE': '0',
                'OUT_OF_RANGE_NEGATIVE': '0',
                'TITLE': '0'
    });
                ...
                .state('sensorsHome.distance',{
                    ...
                    views: {
                        'distance@':{
                            ...
                            controller: function(SENSOR_TYPE, $sessionStorage){
                                SENSOR_TYPE.ID = "1";
                                SENSOR_TYPE.OUT_OF_RANGE_POSITIVE = "401";
                                SENSOR_TYPE.OUT_OF_RANGE_NEGATIVE = "-1";
                ...
                .state('sensorsHome.temperature',{
                    ...
                    views: {
                        'temperature@':{
                            ...
                            controller: function(SENSOR_TYPE, $sessionStorage){
                                SENSOR_TYPE.ID = "2";
                                SENSOR_TYPE.OUT_OF_RANGE_POSITIVE = "101";
                                SENSOR_TYPE.OUT_OF_RANGE_NEGATIVE = '-51';
                    ...
                    views: {
                       'electricalCurrent@':{
                            ...
                            controller: function(SENSOR_TYPE, $sessionStorage){
                               ...
                               SENSOR_TYPE.OUT_OF_RANGE_POSITIVE = "101";
                                SENSOR_TYPE.OUT_OF_RANGE_NEGATIVE = '-50';
                               $sessionStorage.home = false;
                               $sessionStorage.gateWay = false;
                               $sessionStorage.sens = true;
                           }
